...
class ButtonScreenshot(ButtonBase):
    ...
    # TODO: Move screenshot function to DSD subagent, and add a Take Screenshot option to the tray menu
    ...
    def _save_deck_screenshot(self):
        icons = self.page.images  # List of PIL.Image.Image
